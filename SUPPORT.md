...
- **Bug Reports:** If the app behaves unexpectedly, please open an issue using the [Bug Report Template](.github/ISSUE_TEMPLATE/bug_report.md).
- **Service Status Corrections:** If a service's endpoint or status classification is inaccurate on your ISP, submit a [Service Status Correction](.github/ISSUE_TEMPLATE/service_status_correction.md).
- **Feature Requests:** Share your ideas for new diagnostics or game servers using the [Feature Request Template](.github/ISSUE_TEMPLATE/feature_request.md).
